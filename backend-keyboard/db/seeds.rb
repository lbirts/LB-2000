...
s37 = Sound.create(sound_name: "Dank Master", filename: "../backend-keyboard/Media/Wub/Dank Master.fxp", category: c5)
s38 = Sound.create(sound_name: "Very Noice", filename: "../backend-keyboard/Media/Wub/VERY NOICE.fxp", category: c5)
s39 = Sound.create(sound_name: "Timmy", filename: "../backend-keyboard/Media/Wub/Timmy Burner.fxp", category: c5)
s40 = Sound.create(sound_name: "Lemongrab", filename: "../backend-keyboard/Media/Wub/Lemongrab.fxp", category: c5)
s41 = Sound.create(sound_name: "Extreme", filename: "../backend-keyboard/Media/Wub/EXTREME HARD LMAO.fxp", category: c5)
s42 = Sound.create(sound_name: "Mine", filename: "../backend-keyboard/Media/Wub/MineBraft.fxp", category: c5)
s43 = Sound.create(sound_name: "DSG", filename: "../backend-keyboard/Media/Wub/DSG Bass.fxp", category: c5)
s44 = Sound.create(sound_name: "REM", filename: "../backend-keyboard/Media/Wub/REM.fxp", category: c5)
s45 = Sound.create(sound_name: "Sponge", filename: "../backend-keyboard/Media/Wub/SpongeGay.fxp", category: c5)
